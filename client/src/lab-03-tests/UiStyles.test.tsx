...
describe("UI-STYLE-04: Lab 3 authentication screens follow the Zen Green system", () => {
  it("labels Login and Change Password fields and styles their primary actions", () => {
    const login = render(<Login onLogin={() => undefined} />);
